...
pub fn animation_paths() -> HashMap<Animation, AssetPath<'static>> {
    ...
    .chain(load_glb_animations(
        ...
        vec![
            ...
            MizkuAnimation::SkyStab,
            MizkuAnimation::Stagger,
            MizkuAnimation::StandThrowHit,
            ...
            MizkuAnimation::SwordStanceEnter,
            MizkuAnimation::SwordStanceExit,
            MizkuAnimation::SwordStanceLowSlash,
            MizkuAnimation::SwordStanceHighSlash,
            MizkuAnimation::TPose,
            MizkuAnimation::Uppercut,
            MizkuAnimation::ViperStrike,
