...
pub const ITEM_SLOT_COMPONENT_COLOR: Color = Color::YELLOW;
pub const ITEM_SLOT_UPGRADE_COLOR: Color = Color::BLUE;
pub const ITEM_SLOT_OWNED_COLOR: Color = Color::GREEN;
...
// UI
pub const LOADING_SCREEN_BACKGROUND: Color = Color::rgb(0.2, 0.2, 0.2);
